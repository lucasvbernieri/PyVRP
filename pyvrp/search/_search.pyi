...
class RelocateDelivery(UnaryOperator): ...
class RelocatePickup(UnaryOperator): ...
class RemoveAdjacentDepot(UnaryOperator): ...
class RemoveOptionalClient(UnaryOperator): ...
class RemoveOptionalShipment(UnaryOperator): ...
class ReplaceGroup(UnaryOperator): ...
class InsertOptionalClient(BinaryOperator): ...
class InsertOptionalShipment(BinaryOperator): ...
class ReplaceOptionalClient(BinaryOperator): ...
class ReplaceOptionalShipment(BinaryOperator): ...
class Relocate1(BinaryOperator): ...
class Relocate2(BinaryOperator): ...
class Relocate3(BinaryOperator): ...
class Swap11(BinaryOperator): ...
class Swap21(BinaryOperator): ...
class Swap22(BinaryOperator): ...
class Swap31(BinaryOperator): ...
class Swap32(BinaryOperator): ...
class Swap33(BinaryOperator): ...
class RelocateAlternative(BinaryOperator): ...
class RelocateShipment(BinaryOperator): ...
...
class SearchSpace:
    ...
    def neighbours_of(self, activity: Activity) -> list[Activity]: ...
    def is_promising(self, activity: Activity) -> bool: ...
    @overload
    def mark_promising(self, activity: Activity) -> None: ...
    @overload
    def mark_promising(self, node: Node) -> None: ...
    def mark_all_promising(self) -> None: ...
    def unmark_all_promising(self) -> None: ...
    def activity_order(self) -> list[Activity]: ...
...
class Solution:
    ...
    def __getitem__(self, activity: Activity) -> Node | None: ...
